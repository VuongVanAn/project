...
<c:url var="validateExcel" value="/admin-examination-import-validate.html"/>
<c:url var="importExcel" value="/admin-examination-import.html"/>
<html>
<head>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="${validateExcel}" method="post" enctype="multipart/form-data" id="formImport">
                        ...
                        <c:if test="${not empty items.examinationQuestionDTOS}">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-responsive">
                                        <fmt:bundle basename="ResourcesBundle">
                                            <display:table name="items.examinationQuestionDTOS" cellspacing="0" cellpadding="0" requestURI="${requestUrl}"
                                                ...
                                                <display:column headerClass="text-left" property="image" titleKey="label.examination.image"/>
                                                <display:column headerClass="text-left" property="audio" titleKey="label.examination.audio"/>
                                                <display:column headerClass="text-left" property="question" titleKey="label.examination.question"/>
                                                <display:column headerClass="text-left" property="examinationId" titleKey="label.examination.examinationId"/>

...
<c:set var="SPEAKING" value="<%=WebConstant.EXAMINATION_TYPE_SPEAKING%>"/>
<c:set var="GRAMMAR" value="<%=WebConstant.EXAMINATION_TYPE_GRAMMAR%>"/>
<c:set var="QUESTION_RESPONSE" value="<%=WebConstant.EXAMINATION_TYPE_QUESTION_RESPONSE%>"/>
            ...
            <c:forEach items="${items.listResult}" var="item">
                ...
                <c:choose>
                    <c:when test="${item.type == PHOTO}">
                        <p>
                            <img src="<c:url value="/repository/${item.image}"/>" width="300px" height="300px">
                        </p>
                        <p>
                            <audio controls>
                    ...
                    <c:when test="${item.type == SPEAKING}">

                ...
                <c:forEach var="item" items="${items.listResult}">
                    <div class="image group">
                        <div class="grid images_3_of_1">
                            <img src="<c:url value="/repository/exercise/thumbexam.png"/>" alt="" class="img-rounded" width="150px" height="150px" />
                        </div>
                        <div class="grid news_desc">
                            ...
                            <c:if test="${not empty login_name}">
                                <h4><span><a href="${detailUrl}">Làm bài thi &rarr;</a></span></h4>
                            </c:if>

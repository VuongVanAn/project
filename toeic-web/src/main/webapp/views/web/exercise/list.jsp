                ...
                <c:forEach var="item" items="${items.listResult}">
                    <div class="image group">
                        <div class="grid images_3_of_1">
                            <img src="<c:url value="/repository/exercise/thumbexercise.png"/>" class="img-rounded" alt="" width="150px" height="150px" />
                        </div>
                        <div class="grid news_desc">
                            ...
                            <h4><span><a href="${detailUrl}">Chi tiết &rarr;</a></span></h4>
                        </div>
                    </div>
                </c:forEach>

...
public class ExaminationQuestionBeanUtil {
    public static ExaminationQuestionDTO toDto(ExaminationQuestionEntity entity) {
    ...
    public static ExaminationQuestionEntity toEntity(ExaminationQuestionDTO dto) {
